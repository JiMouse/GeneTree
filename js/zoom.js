//zoom
(function(pzoom, $, undefined) {
    
    // initialise zoom and drag
    pzoom.init_zoom= function(opts, svg) {
...
}(window.pzoom = window.pzoom || {}, jQuery));
